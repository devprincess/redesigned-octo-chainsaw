...
INSERT INTO product(name, description, price, idcategory, views) VALUES ('Harry Potter: Harry Potter and the Chamber of Secrets','Harry Potters summer has included the worst birthday ever, doomy warnings from a house-elf called Dobby, and rescue from the Dursleys by his friend Ron Weasley in a magical flying car! Back at Hogwarts School of Witchcraft and Wizardry for his second year, Harry hears strange whispers echo through empty corridors - and then the attacks start. Students are found as though turned to stone . Dobbys sinister predictions seem to be coming true.', 35.20, 1, 0);
INSERT INTO product(name, description, price, idcategory, views) VALUES ('Harry Potter: Harry Potter and the Half Blood Prince','When Dumbledore arrives at Privet Drive one summer night to collect Harry Potter, his wand hand is blackened and shrivelled, but he does not reveal why. Secrets and suspicion are spreading through the wizarding world, and Hogwarts itself is not safe. Harry is convinced that Malfoy bears the Dark Mark: there is a Death Eater amongst them. Harry will need powerful magic and true friends as he explores Voldemort darkest secrets, and Dumbledore prepares him to face his destiny.', 33.50, 1, 0);

INSERT INTO product(name, description, price, idcategory, views) VALUES ('Bluetooth Speaker','PartyUp from Ultimate Ears allows you to wirelessly connect more than 50 UE speakers',90.00,2, 0);
INSERT INTO product(name, description, price, idcategory, views) VALUES ('Samsung Galaxy S3 8GB','Display: 4.8-inches - Camera: 8-MP - Processor Speed: 1.5 GHz - OS: Android 4.1 (Jelly Bean)',93.00,2, 0);
INSERT INTO product(name, description, price, idcategory, views) VALUES ('Apple iPhone 4S 8GB','Resolution 640 x 960 pixels (~330 ppi pixel density) - Protection Corning Gorilla Glass, oleophobic coating',70.00,2, 0);

INSERT INTO product(name, description, price, idcategory, views) VALUES ('Shirt 1','A CLASSIC LOOK FOR EVERYONE: Stanzino presents a classic must have for women everywhere. Our Perfect Fit V Neck Tunic is an essential addition to your wardrobe. Ideal for women of all sizes, this fashionable tunic has a distinct silhouette featuring a ¾ sleeve, V-Neckline, and a high-low hem that drapes low along the back.', 20.00, 3, 0);
INSERT INTO product(name, description, price, idcategory, views) VALUES ('Shirt 2','A CLASSIC LOOK FOR EVERYONE: Stanzino presents a classic must have for women everywhere. Our Perfect Fit V Neck Tunic is an essential addition to your wardrobe. Ideal for women of all sizes, this fashionable tunic has a distinct silhouette featuring a ¾ sleeve, V-Neckline, and a high-low hem that drapes low along the back.', 25.00, 3, 0);
INSERT INTO product(name, description, price, idcategory, views) VALUES ('Pants','A CLASSIC LOOK FOR EVERYONE: Stanzino presents a classic must have for women everywhere. Our Perfect Fit V Neck Tunic is an essential addition to your wardrobe. Ideal for women of all sizes, this fashionable tunic has a distinct silhouette featuring a ¾ sleeve, V-Neckline, and a high-low hem that drapes low along the back.', 50.00, 3, 0);
